    ...
    >
      <header className="topbar">
        ...
        <div className="topbar-tools">
          ...
          <button className="button topbar-plain" aria-label="Importieren" title="Importieren" onClick={() => importRef.current?.click()}><FileUp size={15}/><span className="optional-label">Importieren</span></button>
          ...
          <button className="button topbar-plain" aria-label="Exportieren" title="Exportieren" onClick={async () => { try { await editor.exportProject() } catch (error) { toast(error instanceof Error ? error.message : 'Exportfehler', 'error') } }}><Download size={15}/><span className="optional-label">Exportieren</span></button>
          <button className="button topbar-plain" aria-label="Karte" title="Karte" onClick={() => { setAssetSelectionField('backgroundAssetId'); setAssetManagerOpen(true) }}><ImageIcon size={15}/><span className="optional-label">Karte</span></button>
          ...
          <button className="button topbar-plain" aria-label="Ressourcen" title="Ressourcen" onClick={() => { setAssetSelectionField(null); setAssetManagerOpen(true) }}><Archive size={15}/><span className="optional-label">Ressourcen</span></button>
        </div>
