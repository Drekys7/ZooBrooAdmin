...
export const CreateItemInputSchema = z.object({
  ...
  imageAssetIds: z.array(EntityIdSchema).optional().default([]),
  colorOverride: z.string().regex(/^#[0-9a-f]{6}$/i).nullable().optional().default(null),
  markerOverrides: MarkerOverridesSchema.nullable().optional().default(null),
...
export const UpdateItemInputSchema = z.object({
  ...
  patch: z
    .object({
      ...
      markerOverrides: MarkerOverridesSchema.nullable(),
      position: RawPositionSchema,
